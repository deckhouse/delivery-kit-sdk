...
replace github.com/sigstore/sigstore/pkg/signature/kms/hashivault => github.com/nervgh/sigstore/pkg/signature/kms/hashivault v1.9.6-0.20250808120345-a16cdd935f7a
